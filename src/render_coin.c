...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/03 20:18:15 by jabilbo           #+#    #+#             */
/*   Updated: 2021/05/03 20:22:52 by jabilbo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_coin(t_wolf *wolf, SDL_Surface *surface)
{
	...
	coin.cut_vertical_img.x = (int)(coin.flag_1 * (wolf->bon->image_coin->w
				+ 1) / ((W / 32) * (wolf->player->dist_to_canvas / coin.dist)));
